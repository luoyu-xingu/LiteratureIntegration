...
async fn test_get_paper_detail_performance() {
    ...
    assert!(avg_duration < Duration::from_millis(50), 
        "get_paper_detail average duration {:?} exceeds 50ms", avg_duration);
}
...
async fn test_get_graph_data_performance() {
    ...
    assert!(avg_duration < Duration::from_millis(100), 
        "get_graph_data average duration {:?} exceeds 100ms", avg_duration);
}
...
async fn test_create_authors_batch_performance() {
    ...
    assert!(avg_duration < Duration::from_millis(80), 
        "create_authors_batch average duration {:?} exceeds 80ms", avg_duration);
}
...
async fn test_list_papers_performance() {
    ...
    assert!(avg_duration < Duration::from_millis(30), 
        "list_papers_in_workspace average duration {:?} exceeds 30ms", avg_duration);
}
...
async fn test_search_by_keyword_performance() {
    ...
    assert!(avg_duration < Duration::from_millis(50), 
        "search_by_keyword average duration {:?} exceeds 50ms", avg_duration);
}