...
use crate::models::dto::{ImportPaperRequest, UpdatePaperRequest, PaperDetailResponse, RemovedResponse};
...
pub async fn delete_paper(
    ...
    // 直接序列化类型化结构体，输出 `{"removed":true}`，避免 serde_json::json! 的中间 Value 分配
